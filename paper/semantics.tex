...
\begin{ingraph}
  ...
  \end{minipage}};
\end{ingraph}
\figcap{The object graph with a few objects from the Eq.~\ref{eq:book2}, where
...
\begin{center}\begin{ingraph}
  ...
  \node[object, below=0.7cm of v3] (d3) {\ff{8}};
