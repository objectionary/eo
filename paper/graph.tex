...
\begin{ingraph}
  ...
  \node[object] (v1) [right of=v0] {$v_1$};
    \draw (v0) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v1) node [attr] {\fe{circle}};
  \node[object] (v2) [below of=v1] {$v_2$};
    \draw (v1) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v2) node [attr] {\fe{center}};
  \node[object] (v3) [below left of=v1] {$v_3$};
    \draw (v1) -- pic[sloped,rho,auto,swap]{parallel arrow={-0.3,-0.15}} (v3) node [attr] {\fe{radius}};
  \node[object] (v4) [below right of=v1] {$v_4$};
    \draw (v1) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v4) node [attr] {\fe{is-inside}};
  \node[object] (v6) [below right=1cm of v4] {$v_6$};
    \draw (v4) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v6) node [attr] {\fe{p}};
  \node[dup] (v2d1) [right=1.8cm of v1] {$v_2$};
    \draw[ref] (v1) -- (v2d1) node [attr] {$\varphi$}  node [locator] {$\xi.\fe{center}$};
  ...
  \node[dup] (v3d1) [below=1.5cm of v25] {$v_3$};
    \draw[ref] (v25) -- (v3d1) node [attr] {\fe{other}}  node [locator] {$\rho.\rho.\fe{radius}$};
  ...
  \node[object] (v24) [below=0.6cm of v7] {$v_{24}$};
    \draw[parent] (v24) -- (v7);
    \draw (v5) edge[bend left=30] node [attr] {\fe{t}} pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v24);
  \node[dup] (v6d1) [below=1cm of v24] {$v_6$};
    \draw[ref] (v24) -- (v6d1) node [attr] {\fe{to}}  node [locator] {$\rho.\rho.\fe{p}$};
  \node[dup] (v2d1) [right=1.8cm of v7] {$v_2$};
    \draw[ref] (v7) -- (v2d1) node [attr] {\fe{t}}  node [locator] {$\rho.\rho.\rho.\varphi$};

  \node[object] (v15) [below=0.6cm of v2] {$v_{15}$};
    \node[dup] (v0d1) [left=1cm of v15] {$\Phi$};
    \draw (v0d1) -- (v15) node [attr] {\fe{point}};
  \node[object] (v16) [below left=1cm of v15] {$v_{16}$};
    \draw (v15) -- pic[sloped,rho]{parallel arrow={-0.3,-0.15}} (v16) node [attr] {\fe{x}};
  \node[object] (v17) [below right=1cm of v15] {$v_{17}$};
    \draw (v15) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v17) node [attr] {\fe{y}};
  \node[atom] (v14) [below=2cm of v15] {$v_{14}$} node[lambda] at (v14.south east) {$M_{14}$};
    \draw (v15) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v14) node [attr] {\fe{distance}};
  \node[object] (v18) [left=1cm of v14] {$v_{18}$};
    \draw (v14) -- pic[sloped,rho]{parallel arrow={-0.3,-0.15}} (v18) node [attr] {\fe{to}};

  \node[object] (v10) [below right=1cm and 5cm of v15] {$v_{10}$};
    \node[dup] (v0d2) [left=1cm of v10] {$\Phi$};
    \draw (v0d2) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v10) node [attr] {\fe{c}};
  \node[dup] (v1d1) [above right=0.8cm of v10] {$v_{1}$};
    \draw[parent] (v10) -- (v1d1);
  \node[object] (v19) [below left=1.5cm of v10] {$v_{19}$};
    \draw (v10) -- pic[sloped,rho]{parallel arrow={-0.3,-0.15}} (v19) node [attr] {\fe{radius}};
  ...
  \node[object] (v11) [below right=2cm and 0.5cm of v10] {$v_{11}$};
    \draw (v10) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v11) node [attr] {\fe{center}};
  \node[dup] (v15d1) [left=1cm of v11] {$v_{15}$};
    \draw[parent] (v11) -- (v15d1);
  \node[object] (v20) [below left=1cm of v11] {$v_{20}$};
    \draw (v11) -- pic[sloped,rho]{parallel arrow={-0.3,-0.15}} (v20) node [attr] {\fe{x}};
  ...
  \node[object] (v21) [below right=1cm of v11] {$v_{21}$};
    \draw (v11) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v21) node [attr] {\fe{y}};
  ...
  \node[object] (v22) [below left=1cm of v13] {$v_{22}$};
    \draw (v13) -- pic[sloped,rho]{parallel arrow={-0.3,-0.15}} (v22) node [attr] {\fe{x}};
  ...
  \node[object] (v23) [below right=1cm of v13] {$v_{23}$};
    \draw (v13) -- pic[sloped,rho]{parallel arrow={0.3,-0.15}} (v23) node [attr] {\fe{y}};
  ...
  \begin{minipage}{25em}\raggedright
    ...
    $d_{22} \to +1$ \\
    $d_{23} \to +7$ \\
    $M_{14} \to \sqrt{\begin{matrix*}[l](\mathbb{R}(\xi.\fe{to}.\fe{x}, \delta, s)-\mathbb{R}(\rho.\fe{x}, \delta, s))^2 + \\ + (\mathbb{R}(\xi.\fe{to}.\fe{y}, \delta, s)-\mathbb{R}(\rho.\fe{y}, \delta, s))^2\end{matrix*}}$ \\
    $M_5 \to \mathbb{R}(\xi.\fe{t}, \fe{leq}, s)$ \\
    $M_7 \to \mathbb{R}(\xi.\fe{t}, \fe{distance}, s)$ \\
  \end{minipage}};
\end{ingraph}}