Fig.~\ref{fig:bnf} demonstrates the entire syntax of \eolang{} language in BNF.
...
\end{tabbing}
\end{multicols}
\figcap{The full syntax of \eolang{} in BNF.
...
Due the nesting nature of \eolang{}, its program can be transformed
