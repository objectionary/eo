...
\ff{string} & \ff{"Hello, \foreignlanguage{russian}{друг}!" or \ff{"\textbackslash{}u5BB6" or \begin{CJK}{UTF8}{gbsn}\ff{"家"}\end{CJK} } & 16 \\
\ff{int} & \ff{-42} & 8 \\
...
``Example''. UTF-8 is the encoding used in \ff{string}
