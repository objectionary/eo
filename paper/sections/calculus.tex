...
has three objects bound to attributes \ff{title}, \ff{price}, and \ff{set-price}:
...
$\rho$.$\varphi$.\ff{distance} in Eq.~\ref{eq:c-empty} is semantically equivalent to the expression
