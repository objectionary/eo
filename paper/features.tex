...
between objects is inferred in compile-time and strictly validated, which other
...
The only two possible ways to re-use functionality is via object
...
Haskell, Rust, OCalm, Standard ML, and Swift also don't have NULL references.
...
\ff{system} object of the highest level of abstraction.
...
E.g., an attribute \ff{r} may have an object \ff{random}
