...
| Decimal `INT`/`FLOAT` literal that does not match its IEEE-754 round-trip form (e.g., `2.7182818284590452354`) | `<literal> is over-precise, write <canonical> instead` (literal and canonical substituted) |
