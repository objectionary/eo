...
final class StUnhexTest {
    ...
    void convertsNumberFromHexToEo(final Shift shift, final String type) {
        MatcherAssert.assertThat(
            ...
            new Xsline(new StUnhex(shift)).pass(
                new XMLDocument(
                    "<p><o base='Φ.number'><o base='Φ.bytes'><o>43-70-2E-4F-30-46-73-2E</o></o></o></p>"
                )
            ),
            Matchers.anyOf(
    ...
    void convertsMaxIntFromHexToEo(final Shift shift, final String type) {
        MatcherAssert.assertThat(
            ...
            new Xsline(new StUnhex(shift)).pass(
                new XMLDocument(
                    "<p><o base='Φ.number'><o base='Φ.bytes'><o>FF-FF-FF-FF-FF-FF-FF-FF</o></o></o></p>"
                )
            ),
            XhtmlMatchers.hasXPath(
                "//o[@base='Φ.number' and o[@base='Φ.bytes' and not(o) and text()!='']]"
            )
        );
    }
        ...
        MatcherAssert.assertThat(
            ...
            new Xsline(new StUnhex(shift)).pass(
                new XMLDocument(
                    String.join(
                        "",
                        "<p><o base='Φ.string'><o base='Φ.bytes'><o>41-42-0A-09</o></o></o>",
                        "<o base='Φ.string'><o base='Φ.bytes'><o>41-42</o></o></o></p>"
                    )
                )
            ),
    ...
    void convertsEmptyStringFromHexToEo(final Shift shift, final String type) {
        MatcherAssert.assertThat(
            ...
            new Xsline(new StUnhex(shift)).pass(
                new XMLDocument(
                    "<p><o base='Φ.string'><o base='Φ.bytes'/><o/></o></p>"
                )
            ),
    ...
    void convertsStringWithDoubleSpacesFromHexToEo(final Shift shift, final String type) {
        MatcherAssert.assertThat(
            ...
            new Xsline(new StUnhex(shift)).pass(
                new XMLDocument(
                    "<o base=\"Φ.string\"><o base=\"Φ.bytes\"><o>7A-0A-20-20-79-0A-20-78</o></o></o>"
                )
            ),
    ...
    void convertsNegativeZeroFromHexToEo(final Shift shift, final String type) {
        MatcherAssert.assertThat(
            ...
            new Xsline(new StUnhex(shift)).pass(
                new XMLDocument(
                    "<o base='Φ.number'><o base='Φ.bytes'><o>80-00-00-00-00-00-00-00</o></o></o>"
                )
            ),
    ...
    void convertsFloatFromHexToEo(final Shift shift, final String type) {
        MatcherAssert.assertThat(
            ...
            new Xsline(new StUnhex(shift)).pass(
                new XMLDocument(
                    "<p><o base='Φ.number'><o base='Φ.bytes'><o>41-42-43-67-AE-CD-3E-FD</o></o></o></p>"
                )
            ),
            Matchers.anyOf(
