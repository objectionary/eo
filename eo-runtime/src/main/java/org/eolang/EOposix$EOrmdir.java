...
/**
 * Removes an empty directory, as POSIX `rmdir` does.
 *
 ...
 */
@XmirObject(oname = "posix.rmdir")
@SuppressWarnings("PMD.AvoidDollarSigns")
public final class EOposix$EOrmdir extends PhDefault implements Atom {

    /**
     * Ctor.
     */
    public EOposix$EOrmdir() {
