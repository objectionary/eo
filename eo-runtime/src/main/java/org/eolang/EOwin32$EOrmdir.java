...
/**
 * Removes an empty directory, as msvcrt `_wrmdir` does.
 *
 ...
 */
@XmirObject(oname = "win32.rmdir")
@SuppressWarnings("PMD.AvoidDollarSigns")
public final class EOwin32$EOrmdir extends PhDefault implements Atom {

    /**
     * Ctor.
     */
    public EOwin32$EOrmdir() {
