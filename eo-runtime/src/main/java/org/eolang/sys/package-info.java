 ...
 * {@code Cstring} and {@code TupleToArray}, which size a read and carry a
 * pointer, a text and a tuple of arguments across to C on their behalf.
 * Both families sit under this package too, as {@code org.eolang.sys.posix}
 * and {@code org.eolang.sys.win32}, so a reader finds the adapters where
 * what they share already lives.</p>
 *
 * @since 0.77.0
 */
