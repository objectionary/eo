...
```text
to-java.xsl              86474  39.01%
classes.xsl              72805  32.84%
set-locators.xsl         16180  7.30%
set-original-names.xsl   11353  5.12%
attrs.xsl                9302   4.20%
data.xsl                 8052   3.63%
tests.xsl                5922   2.67%
package.xsl              5852   2.64%
anonymous-to-nested.xsl  5748   2.59%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-06 at 03:09,
on Linux with 4 CPUs.
The total is 221688 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/17509093760
