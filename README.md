...
```text
to-java.xsl              96245  41.84%
classes.xsl              71709  31.17%
set-locators.xsl         16058  6.98%
set-original-names.xsl   10318  4.49%
attrs.xsl                9113   3.96%
data.xsl                 8332   3.62%
package.xsl              6129   2.66%
tests.xsl                6101   2.65%
anonymous-to-nested.xsl  6019   2.62%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-01-10 at 03:53,
on Linux with 4 CPUs.
The total is 230024 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/20872255397
