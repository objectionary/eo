...
```text
to-java.xsl              65784  36.93%
classes.xsl              50874  28.56%
set-locators.xsl         16308  9.15%
set-original-names.xsl   10739  6.03%
attrs.xsl                9042   5.08%
data.xsl                 8128   4.56%
package.xsl              5918   3.32%
tests.xsl                5792   3.25%
anonymous-to-nested.xsl  5548   3.11%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-11-21 at 10:06,
on Linux with 4 CPUs.
The total is 178133 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/19566783080
