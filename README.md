...
```text
to-java.xsl              79990  37.17%
classes.xsl              63887  29.69%
set-locators.xsl         17533  8.15%
set-original-names.xsl   12092  5.62%
attrs.xsl                11063  5.14%
data.xsl                 9812   4.56%
tests.xsl                7187   3.34%
package.xsl              6843   3.18%
anonymous-to-nested.xsl  6790   3.16%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-02-06 at 08:07,
on Linux with 4 CPUs.
The total is 215197 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/21743160094
