...
```text
to-java.xsl              81767  41.69%
classes.xsl              58001  29.57%
set-locators.xsl         15344  7.82%
set-original-names.xsl   10787  5.50%
attrs.xsl                7651   3.90%
data.xsl                 6976   3.56%
anonymous-to-nested.xsl  5421   2.76%
package.xsl              5149   2.63%
tests.xsl                5056   2.58%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-06-15 at 11:30,
on Linux with 4 CPUs.
The total is 196152 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/15662627833
