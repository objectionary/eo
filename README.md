...
```text
to-java.xsl              77932  37.22%
classes.xsl              58638  28.00%
set-locators.xsl         19747  9.43%
set-original-names.xsl   12784  6.11%
attrs.xsl                10758  5.14%
data.xsl                 9878   4.72%
anonymous-to-nested.xsl  6700   3.20%
tests.xsl                6519   3.11%
package.xsl              6432   3.07%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-11-30 at 04:22,
on Linux with 4 CPUs.
The total is 209388 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/19793682465
