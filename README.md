...
```text
to-java.xsl              79503  37.09%
classes.xsl              74957  34.97%
set-locators.xsl         17036  7.95%
set-original-names.xsl   10411  4.86%
attrs.xsl                8336   3.89%
data.xsl                 7580   3.54%
package.xsl              5656   2.64%
anonymous-to-nested.xsl  5530   2.58%
tests.xsl                5317   2.48%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-10-18 at 05:10,
on Linux with 4 CPUs.
The total is 214326 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/18611075163
