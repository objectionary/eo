...
```text
to-java.xsl              67838  36.60%
classes.xsl              55134  29.74%
set-locators.xsl         14969  8.08%
set-original-names.xsl   10644  5.74%
attrs.xsl                9348   5.04%
data.xsl                 8459   4.56%
anonymous-to-nested.xsl  6370   3.44%
tests.xsl                6356   3.43%
package.xsl              6239   3.37%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-03-11 at 09:05,
on Linux with 4 CPUs.
The total is 185357 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/22944585022
