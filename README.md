...
```text
to-java.xsl              74701  42.44%
classes.xsl              53576  30.44%
set-locators.xsl         12444  7.07%
set-original-names.xsl   9167   5.21%
attrs.xsl                6641   3.77%
data.xsl                 6119   3.48%
tests.xsl                4612   2.62%
anonymous-to-nested.xsl  4478   2.54%
package.xsl              4257   2.42%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-06-27 at 18:05,
on Linux with 4 CPUs.
The total is 175995 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/15932731819
