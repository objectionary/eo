...
```text
to-java.xsl              90277  39.44%
classes.xsl              76056  33.23%
set-locators.xsl         17737  7.75%
set-original-names.xsl   11317  4.94%
attrs.xsl                8878   3.88%
data.xsl                 8038   3.51%
anonymous-to-nested.xsl  5759   2.52%
tests.xsl                5521   2.41%
package.xsl              5317   2.32%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-13 at 17:07,
on Linux with 4 CPUs.
The total is 228900 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/17699462312
