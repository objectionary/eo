...
```text
to-java.xsl              15836  25.80%
set-original-names.xsl   11822  19.26%
classes.xsl              9021   14.70%
set-locators.xsl         6160   10.04%
attrs.xsl                4661   7.59%
data.xsl                 3682   6.00%
anonymous-to-nested.xsl  3508   5.71%
tests.xsl                3412   5.56%
package.xsl              3281   5.35%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-08-22 at 20:26,
on Linux with 4 CPUs.
The total is 61383 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/32596126359
