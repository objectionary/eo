...
```text
to-java.xsl              79234  41.77%
classes.xsl              55630  29.33%
set-locators.xsl         14548  7.67%
set-original-names.xsl   10543  5.56%
attrs.xsl                7559   3.98%
data.xsl                 6917   3.65%
anonymous-to-nested.xsl  5142   2.71%
tests.xsl                5095   2.69%
package.xsl              5023   2.65%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-07-04 at 11:09,
on Linux with 4 CPUs.
The total is 189691 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/16072206552
