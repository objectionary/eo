...
```text
to-java.xsl              78021  38.53%
classes.xsl              66821  33.00%
set-locators.xsl         16812  8.30%
set-original-names.xsl   10532  5.20%
attrs.xsl                7899   3.90%
data.xsl                 6944   3.43%
tests.xsl                5333   2.63%
anonymous-to-nested.xsl  5188   2.56%
package.xsl              4967   2.45%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-08-30 at 03:18,
on Linux with 4 CPUs.
The total is 202517 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/17338627228
