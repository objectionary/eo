...
```text
to-java.xsl              75835  39.87%
classes.xsl              61002  32.07%
set-locators.xsl         14289  7.51%
set-original-names.xsl   9446   4.97%
attrs.xsl                7376   3.88%
data.xsl                 6791   3.57%
tests.xsl                5274   2.77%
anonymous-to-nested.xsl  5225   2.75%
package.xsl              4989   2.62%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-08-25 at 15:11,
on Linux with 4 CPUs.
The total is 190227 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/17212652886
