...
```text
to-java.xsl              83097  39.13%
classes.xsl              70178  33.04%
set-locators.xsl         16660  7.84%
set-original-names.xsl   10466  4.93%
attrs.xsl                8399   3.95%
data.xsl                 7402   3.49%
anonymous-to-nested.xsl  5394   2.54%
tests.xsl                5392   2.54%
package.xsl              5384   2.54%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-16 at 03:28,
on Linux with 4 CPUs.
The total is 212372 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/17753421328
