...
```text
to-java.xsl              95831  38.49%
classes.xsl              82977  33.32%
set-locators.xsl         18866  7.58%
set-original-names.xsl   12395  4.98%
attrs.xsl                10230  4.11%
data.xsl                 9006   3.62%
anonymous-to-nested.xsl  6979   2.80%
package.xsl              6421   2.58%
tests.xsl                6293   2.53%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-26 at 10:29,
on Linux with 4 CPUs.
The total is 248998 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/18033248342
