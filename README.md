...
```text
to-java.xsl              56534  34.84%
classes.xsl              53389  32.90%
set-locators.xsl         13320  8.21%
set-original-names.xsl   9004   5.55%
attrs.xsl                7889   4.86%
data.xsl                 7181   4.43%
anonymous-to-nested.xsl  5095   3.14%
package.xsl              4942   3.05%
tests.xsl                4923   3.03%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-03-30 at 05:11,
on Linux with 4 CPUs.
The total is 162277 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/23728844634
