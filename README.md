...
```text
to-java.xsl              70308  37.34%
classes.xsl              53102  28.20%
set-locators.xsl         17105  9.08%
set-original-names.xsl   10839  5.76%
attrs.xsl                9686   5.14%
data.xsl                 8439   4.48%
tests.xsl                6591   3.50%
package.xsl              6221   3.30%
anonymous-to-nested.xsl  5990   3.18%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-12-06 at 16:45,
on Linux with 4 CPUs.
The total is 188281 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/19991303677
