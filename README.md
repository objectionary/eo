...
```text
to-java.xsl              81142  41.55%
classes.xsl              57753  29.57%
set-locators.xsl         14854  7.61%
set-original-names.xsl   10694  5.48%
attrs.xsl                8012   4.10%
data.xsl                 7301   3.74%
anonymous-to-nested.xsl  5411   2.77%
package.xsl              5209   2.67%
tests.xsl                4925   2.52%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-06-14 at 04:13,
on Linux with 4 CPUs.
The total is 195301 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/15648211467
