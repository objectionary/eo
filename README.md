...
```text
to-java.xsl              81194  42.16%
classes.xsl              59893  31.10%
set-locators.xsl         14375  7.46%
set-original-names.xsl   9122   4.74%
attrs.xsl                6937   3.60%
data.xsl                 6194   3.22%
tests.xsl                4963   2.58%
package.xsl              4951   2.57%
anonymous-to-nested.xsl  4948   2.57%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-08-01 at 07:37,
on Linux with 4 CPUs.
The total is 192577 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/16669090691
