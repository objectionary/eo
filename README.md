...
```text
to-java.xsl              84156  42.22%
classes.xsl              60311  30.25%
set-locators.xsl         15420  7.74%
set-original-names.xsl   10811  5.42%
attrs.xsl                7043   3.53%
data.xsl                 6449   3.24%
anonymous-to-nested.xsl  5241   2.63%
tests.xsl                5042   2.53%
package.xsl              4873   2.44%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-07-16 at 12:34,
on Linux with 4 CPUs.
The total is 199346 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/16319190537
