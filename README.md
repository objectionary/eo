...
```text
to-java.xsl              71055  37.09%
classes.xsl              57991  30.27%
set-locators.xsl         15728  8.21%
set-original-names.xsl   10794  5.63%
attrs.xsl                9191   4.80%
data.xsl                 8541   4.46%
anonymous-to-nested.xsl  6247   3.26%
package.xsl              6064   3.17%
tests.xsl                5971   3.12%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-01-29 at 04:47,
on Linux with 4 CPUs.
The total is 191582 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/21465722537
