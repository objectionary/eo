...
```text
to-java.xsl              73268  38.07%
classes.xsl              53340  27.72%
set-locators.xsl         16777  8.72%
set-original-names.xsl   11743  6.10%
attrs.xsl                9781   5.08%
data.xsl                 8986   4.67%
tests.xsl                6413   3.33%
package.xsl              6157   3.20%
anonymous-to-nested.xsl  5973   3.10%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-01-18 at 03:48,
on Linux with 4 CPUs.
The total is 192438 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/21105429475
