...
```text
to-java.xsl              71662  37.24%
classes.xsl              58305  30.30%
set-locators.xsl         14606  7.59%
set-original-names.xsl   10303  5.35%
attrs.xsl                9692   5.04%
data.xsl                 8814   4.58%
tests.xsl                6594   3.43%
anonymous-to-nested.xsl  6433   3.34%
package.xsl              6016   3.13%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-03-01 at 12:21,
on Linux with 4 CPUs.
The total is 192425 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/22543180910
