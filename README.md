...
```text
to-java.xsl              90407  38.17%
classes.xsl              79956  33.76%
set-locators.xsl         18833  7.95%
set-original-names.xsl   11738  4.96%
attrs.xsl                9070   3.83%
data.xsl                 8549   3.61%
tests.xsl                6323   2.67%
anonymous-to-nested.xsl  5998   2.53%
package.xsl              5980   2.52%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-10-11 at 03:26,
on Linux with 4 CPUs.
The total is 236854 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/18423621880
