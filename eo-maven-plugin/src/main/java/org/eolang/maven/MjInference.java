 ...
 *
 * <p>The checker looks for one kind of mistake: an attribute is taken from an
 ...
 * files a pending check: this argument must fit into that void.</p>
 *
 * <p>Then the checks are drained one by one, each of them either deciding,
