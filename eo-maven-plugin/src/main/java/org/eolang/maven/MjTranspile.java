...
public final class MjTranspile extends MjSafe {
     ...
     * its {@code pom.xml}); one setting is enough end to end. This
     * same transpile run also writes the full set of instrumented
     * locations into a sibling manifest (see {@link CoverageManifest});
