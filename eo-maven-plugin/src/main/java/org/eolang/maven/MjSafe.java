 ...
 * @since 0.1
 * @todo #6428:60min Take the caching decision out of this class. It names
 *  30 types now, the maximum, so the next one moved to {@link GlobalCache}
 *  brings the fan-out suppression back. A cache of its own for
 *  {@link #caching(String)} would drop two types from here.
 */
